/*
 * Generated by ISE 18.01.10.1424 GPL Edition - win64
 */
...
void egc_init_plug (void)
{
	...
	egc_strmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F230_6499;
	egc_str32make = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F237_6742;
	egc_arrmake = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F273_3801;
	egc_strset = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F232_6673;
	egc_str32set = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE)) F238_6881;
	egc_routdisp_wb = (void (*)(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) F267_6380;
	...
	egc_sp_bool = 0x01FA;
	egc_sp_uint8 = 0x01D6;
	egc_sp_uint16 = 0x016F;
	egc_sp_uint32 = 0x02D6;
	egc_sp_uint64 = 0x0292;
	egc_sp_int8 = 0x034F;
	egc_sp_int16 = 0x0372;
	egc_sp_int32 = 0x0121;
	egc_sp_int64 = 0x0395;
	egc_sp_real32 = 0x01B2;
	egc_sp_real64 = 0x033C;
	egc_sp_pointer = 0x02E2;
	egc_sp_ref = 0x0115;
	...
	egc_system_name = "introduction";
	egc_system_location = "E:\\CS 2015\\University\\Bacholar IU 2018-2022\\Fall 18 (S1Y1)\\Introduction to programming 1\\Week 1\\Classwork\\lab1_b\\assignment_1\\introduction\\EIFGENs\\introduction\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1534932024;
